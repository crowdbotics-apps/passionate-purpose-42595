...
## Project Structure
    ...
    ├── passionate_purpose_42595  # Django project configurations
...
1. Clone this repo and `cd passionate_purpose_42595`
...
2. Clone this repo and `cd passionate_purpose_42595`
